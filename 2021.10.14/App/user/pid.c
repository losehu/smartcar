...
{
    /*   Kp       Ki       Kd     MaxO    MinO */
    {  3.000f, 0.300f, 0.000f, 100, -100, 1000.0f, -1000.0f }
};
...
{
    /*   Kp       Ki       Kd     MaxO    MinO */
    {  2.000f, 0.600f, 2.000f, 100, -100, 1000.0f, -1000.0f  }
};
float BalancePIDParam[][7] =
{
    ...
    //                 Kp2 5.00                         Kd 40
    { 6.00000f, 0.0f, 0.00000f,    0100.0f,   -0100.0f, 100.0f, -100.0f  },
...
{
    //--------------直立环---------------------//
    //      BalancePID.maxout = 1000;
    //    BalancePID.minout = -1000;
    //    BalancePID.kp = 24.06f;
    //    BalancePID.ki = 0.1f;
    BalancePID.kd = 0.800f;
    //--------------速度环---------------------//
    SpeedPID.maxout = 600;
    SpeedPID.minout = -600;
    SpeedPID.kp = 0.06f;
