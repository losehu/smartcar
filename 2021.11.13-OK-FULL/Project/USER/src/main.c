...
MSH_CMD_EXPORT(set_pid, set_pid: <pid_num> <P> <I> <D>); //设置PID
MSH_CMD_EXPORT(read_pid, read_pid); //设置PID
MSH_CMD_EXPORT(set_speed, set_speed); //设置PID
MSH_CMD_EXPORT(read_speed, read_speed); //设置PID
MSH_CMD_EXPORT(set_view, set_view); //设置PID
MSH_CMD_EXPORT(read_view, read_view); //设置PID
MSH_CMD_EXPORT(set_angle, set_view); //设置PID
MSH_CMD_EXPORT(read_angle, read_view); //设置PID
