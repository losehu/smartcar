...
int16 MT9V03X_CFG[CONFIG_FINISH][2] =  
{
    ...
    {GAIN,              16},                                                // 图像增益         范围16-64     增益可以在曝光时间固定的情况下改变图像亮暗程度
    {INIT,              0}                                                  // 摄像头开始初始化
};
...
void mt9v03x_dma_init(void)
{
    ...
    //中断配置
    nvic_init(MT9V03X_DMA_IRQN, 0x01, 0x01, ENABLE);
}
...
void mt9v03x_init(void)
{
    ...
    // 初始换串口 配置摄像头
    uart_init_zf(MT9V03X_COF_UART, MT9V03X_COF_BAUR, MT9V03X_COF_UART_TX, MT9V03X_COF_UART_RX);
