...
uint8 GetBorder(void)
{
    ...
    for (Ysite = 5; Ysite < 60; Ysite ++)
    {
        ...
        if (Img.RightBorder[Ysite] >= Base.RightMax.x && Img.RightBorder[Ysite] < 128)
        {
            Base.RightMax.x = Img.RightBorder[Ysite];
            Base.RightMax.y = Ysite;
        }
        if (Img.RightBorder[Ysite] <= Base.RightMin.x && Img.RightBorder[Ysite] < 128)
        {
        ...
        if (Ysite > 20)
        {
            ...
            if (Img.RightBorder[Ysite] >= Base.RightMax20up.x && Img.RightBorder[Ysite] < 128)
            {
                Base.RightMax20up.x = Img.RightBorder[Ysite];
                Base.RightMax20up.y = Ysite;
            }
            if (Img.RightBorder[Ysite] <= Base.RightMin20up.x && Img.RightBorder[Ysite] < 128)
            {
