...
////float Vel[4] = {7, 0.03, 0.000, 1000};   // 速度环PID {0.2, 0.007, 0, 500};
//float Vel[4] = {6, 0.02, 0.000, 200};   // 速度环PID {0.2, 0.007, 0, 500};
//float rubo_Vel[4]= {0.6 , 0.0020, 0.01, 100}; //转向角度环
////float Direct[4]  = {5, 0.01, 0.000, 70};	// 转向角速度环PID 位置{0.018, 0.00215, 0.023, 55};
//float Direct[4]  = {2.4, 0.015, 0.000, 100};	// 转向角速度环PID 位置{0.018, 0.00215, 0.023, 55};
float Angle[4]   = {1.3, 0.01, 0.0010, 1};      // 角度环PID{0.2, 0, 0.03, 1000};
float Ang_Vel[4] = {0.06, 0.003, 0.00000, 500};   // 角速度环PID {0.2, 0.007, 0, 500};
//float Vel[4] = {7, 0.03, 0.000, 1000};   // 速度环PID {0.2, 0.007, 0, 500};
float Vel[4] = {6, 0.02, 0.000, 200};   // 速度环PID {0.2, 0.007, 0, 500};
float rubo_Vel[4]= {0.4, 0.0005, 0.01, 70}; //转向角度环
//float Direct[4]  = {5, 0.01, 0.000, 70};	// 转向角速度环PID 位置{0.018, 0.00215, 0.023, 55};
float Direct[4]  = {1.5, 0.005, 0.000, 100};	// 转向角速度环PID 位置{0.018, 0.00215, 0.023, 55};
//环岛转向参数PID
/*******************速度环********************/
