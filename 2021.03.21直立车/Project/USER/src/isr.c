...
void TIM14_IRQHandler (void)
{
    ...
    if (Time_50ms == 50)
    {
        Speed_Flag = 1;
        Time_50ms = 0;
        //		oled_printf_int32(0,0,distance_I,10);
        //		oled_printf_int32(0,1,Tracking_Sensor_data_1_LCD,5);
        //		oled_printf_int32(0,2,Tracking_Sensor_data_2_LCD,5);
        //		oled_printf_int32(0,3,Tracking_Sensor_data_3_LCD,5);
        //		oled_printf_int32(0,4,Tracking_Sensor_data_4_LCD,5);
        //		oled_printf_int32(0,5,Tracking_Sensor_data_5_LCD,5);
        //		oled_printf_int32(0,6,Attitude_Angel_P,5);
        //	    lcd_showint32(0,0,Attitude_Angel_P,5);//x可以为int32 uint16 int16 uint8 int8类型
        lcd_showint32(0, 0, MOTOR_Speed_Left, 5);
        lcd_showint32(0, 1, Attitude_Angel_P , 5);
        //				lcd_showint32(0,2,Tracking_Sensor_data_1_LCD,5);
        //				lcd_showint32(0,3,Tracking_Sensor_data_2_LCD,5);
        //				lcd_showint32(0,4,Tracking_Sensor_data_3_LCD,5);
        //				lcd_showint32(0,5,Tracking_Sensor_data_5_LCD,5);
