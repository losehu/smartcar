...
void Waveform_Write(void)
{
    ...
    waveform[USERDATA_1]   = (short) Radius/Wheel.now;
    waveform[USERDATA_2]   = (short)Radius;
    waveform[USERDATA_3]   = (short)Wheel.now;
    waveform[USERDATA_4]   = (short)ICM_Treated.gyro.z;
    waveform[USERDATA_5]   = (short)( ExSpeed / 100);
    waveform[USERDATA_6]   = (short) ICM_Treated.gyro.z;
    waveform[USERDATA_7]   = (short)Direct_Parameter;
	  waveform[USERDATA_8]   =(short)Radius;
