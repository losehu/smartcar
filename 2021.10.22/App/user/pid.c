...
//P  I  D    MAX_SUM_ERROR
float Angle[4]   = {0.4, 0.0005, 0, 500};       // 角度环PID{0.2, 0, 0.03, 1000};
float Ang_Vel[4] = {0.05, 0.0020, 0, 1000}; // 角速度环PID {0.2, 0.007, 0, 500};
/*******************速度环********************/
...
{
    /*   Kp       Ki       Kd     MaxO    MinO */
    {  3.000f, 0.600f, 2.000f, 100, -100, 1000.0f, -1000.0f }
};
