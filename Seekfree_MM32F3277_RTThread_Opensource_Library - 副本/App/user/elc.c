...
uint8 ELC_Show(void)
{
	while(KeyPageUp != onepress)
	{
		...
		ELC_Center_Calculate();
		IPS114_PENCOLOR = RED;
		ips114_showstr(0,0,(const uint8*)"    L1    L2    L3   L4 ");
		...
		//归一化值
		IPS114_PENCOLOR = RED;
		ips114_showstr(0,2,(const uint8*)"    L1    L2   L3    L4  ");
		IPS114_PENCOLOR = BLUE;
		...
		//14和 23和
		IPS114_PENCOLOR = RED;
		ips114_showstr(0,4,(const uint8*)"  LSUM_14  LSUM_23 LSUM_1234");
		IPS114_PENCOLOR = BLUE;
		...
		//两种中线的值
		IPS114_PENCOLOR = RED;
		ips114_showstr(0,6,(const uint8*)"CENTER_14   CENTER_23");
		IPS114_PENCOLOR = BLUE;
