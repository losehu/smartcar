...
#define OV7725_SIZE             OV7725_W*OV7725_H/16                                    // 图像占用空间大小
...
extern uint8_t ov7725_image_bin0[OV7725_H][OV7725_W / 8];
extern uint8_t ov7725_image_bin1[OV7725_H][OV7725_W / 8];
extern uint8_t ov7725_threshold;
...
//=================================用户部分=========================================//
//-------------------逆透视部分-----------------------//
extern bool NowCollectImg;

//////真实的图像是一个倒着的梯形
////#define   IMAGEREAL_COL   125// (1033+1452)/10 max = 249 = 250 /2 = 125
////#define   IMAGEREAL_ROW   95// (278+1547)/10  max = 183 = 190 /2 = 95

//////真实的图像数组
////extern uint16 ImageReal[IMAGEREAL_ROW][IMAGEREAL_COL];
////extern uint8 ImgLeftBorder[IMAGEREAL_ROW], ImgRightBorder[IMAGEREAL_ROW];
////extern uint8 CamToRealY[80][160];
////extern uint8 CamToRealX[80];
//////function
////uint8   PositionChangeArrayInit(void);
////void    Image_Inverse_Perspective(uint8* src0,uint8 height,uint8 wide);

////void    CameraExtract(void);

//------------------直接解压部分----------------------//
#define IMAGEUSED_COL 128
#define IMAGEUSED_ROW 60

//解压后的图像数组
extern uint8 ImageUsed[IMAGEUSED_ROW][IMAGEUSED_COL];
