...
//P  I  D    MAX_SUM_ERROR
float Angle[4]   = {1.22, 0.00000, 0.008, 500};      // 角度环PID{0.2, 0, 0.03, 1000};
float Ang_Vel[4] = {0.03, 0.002, 0.00000, 1000};   // 角速度环PID {0.2, 0.007, 0, 500};
float Vel[4] = {6.4, 0.07, 0.001, 1000};   // 速度环PID {0.2, 0.007, 0, 500};
float rubo_Vel[4]={0.2, 0.000000, 0.01, 100};//转向角度环
//float Direct[4]  = {5, 0.0000, 0.000, 300};	// 转向角速度环PID 位置{0.018, 0.00215, 0.023, 55};
float Direct[4]  = {1.5, 0.0001, 0.000, 300};	// 转向角速度环PID 位置{0.018, 0.00215, 0.023, 55};
//0.5
float Turn[5][4] = {{100, 2, 1, 100},   //起步转向参数PID
    {100, 3, 2, 100},   //低速转向参数PID
    {0.00001, 0.0, 0, 100},   //中速转向参数PID in use
