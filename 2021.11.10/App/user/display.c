...
extern short pwm_l,pwm_r;// 0 ~ 1000
...
uint8 HMI_Display(int8 page)
{
    ...
    if (KeyPageUp == onepress)
    {
        KeyPageUp = nopress;
						 ips114_clear(RED);
			ips114_showstr(5,5,"running_mode");
      //  FlashParamsWrite();
			return 1;
    }
...
uint8 Adjust_Threshold(void)
{
    while (KeyPageUp != onepress)
    {
        ...
        ips114_showstr(180, 0, "Threshold1:");
        ips114_showuint8(180, 1, Threshold1);
    }
    KeyPageUp = nopress;
    return 0;
}
    ...
    while (KeyPageUp != onepress)
    {
        ...
        Center_Cal();
           ...
           Radius=range_protect(Radius,-180,180);
			    ...
			    Direct_Parameter = -PID_Realize1(&Direct_PID, Direct, ICM_Treated.gyro.z * 100,range_protect(Wheel.now , 200, 590)* Radius);	// 转向角速度环左正右负
        ...
        ips114_showint16(170, 5, Servo_add);
			      ...
			      ips114_showstr(0, 5, "Radius:");
		        ips114_showint16(50, 5, Radius);
	
			      ips114_showstr(0, 6, "D_P:");
		        ips114_showint16(50, 6, Direct_Parameter);
						if(Direct_Parameter) 		        ips114_showint16(0, 8, 1);
else    ips114_showint16(0, 8, 0);
		//	if(Direct_Parameter<)
        ips114_showstr(170, 6, "Threshold1:");
        ips114_showint16(170, 7, Threshold1);
				        ips114_showint16(0, 7, (int16)pwm_l);
        ips114_showint16(80, 7,(int16) pwm_r);
