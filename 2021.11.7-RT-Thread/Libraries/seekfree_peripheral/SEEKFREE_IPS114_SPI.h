...
#define IPS114_REST_PIN         G13                                         // 液晶复位引脚定义 由于实际通讯未使用B2因此 这里复用为GPIO
...
//=======================================================USED===================================================//
void ips114_display_myimage(uint16 *p, uint16 posi_x, uint16 posi_y, \
                            uint16 width, uint16 height, uint16 dis_width, uint16 dis_height);
void ips114_DrawXLine(int16 x, uint16 color, uint16 size);
void ips114_DrawYLine(int16 x, uint16 color, uint16 size);
